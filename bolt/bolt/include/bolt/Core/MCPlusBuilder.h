...
public:
  ...
  virtual void createCallToAddress(MCInst &Inst, const uint64_t TargetAddr,
                  MCContext *Ctx) {
    llvm_unreachable("not implemented");
  }

  virtual void pushRAX(MCInst &Inst, MCContext *Ctx) {
    llvm_unreachable("not implemented");
  }

  virtual void popRAX(MCInst &Inst, MCContext *Ctx) {
    llvm_unreachable("not implemented");
  }
  ...
  virtual InstructionListType replaceFunctionWithCallAndReturn (const MCSymbol *Destination, MCContext *Ctx) const {
    llvm_unreachable("not implemented");
    return {};
  }
  ...
  virtual InstructionListType createConditionalJumpToOutline(const MCSymbol *Target, MCContext *Ctx, MCPhysReg IndirectJumpReg) const {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual InstructionListType createRedirectToOutlinerAnyOtherBB(const MCSymbol *Destination, const MCSymbol *Target, int offset, MCContext *Ctx) const {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual InstructionListType createOutlinerToRedirectAnyOtherBB(int offset) const {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual InstructionListType createRedirectToSuccessorAnyOtherBB() const {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual MCPhysReg getIndirectJmpReg(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }
  ...
  virtual bool isEndingWithCFI(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual bool hasCFI(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual bool SplitPrologue(MCInst &Inst) {
    llvm_unreachable("not implemented");
    return {};
  }
  ...
  virtual bool isPrologue(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual bool isEpilogue(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }
  ...
  virtual bool hasIndirectCalltoRAX(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual bool hasCallInst(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual bool isEqual(const MCInst &A, const MCInst &B) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual int getStackFrameOffset(BinaryFunction *Function, BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual int isStackPointerDecrement(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual void updateStackFrameRegOffset(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
  }

  virtual void setStackPointerDecrement(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
  }

  virtual void setStackPointerIncrement(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
  }

  virtual int isStackPointerIncrement(BinaryBasicBlock *CurBB) {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual InstructionListType createOutlinerToRedirect() const {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual InstructionListType createRedirectToSuccessor(const MCSymbol *Destination, MCContext *Ctx) const {
    llvm_unreachable("not implemented");
    return {};
  }

  virtual InstructionListType createJmpToOutlinerRemainBB(const MCSymbol *Target, MCContext *Ctx) const {
    llvm_unreachable("not implemented");
    return {};
  }
