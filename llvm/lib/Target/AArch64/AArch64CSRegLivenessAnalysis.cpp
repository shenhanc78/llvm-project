...
#define DEBUG_TYPE "aarch64-cs-reg-liveness"
...
using ::llvm::AArch64InstrInfo;
using ::llvm::AArch64RegisterInfo;
using ::llvm::AArch64Subtarget;
...
class AArch64CSRegLivenessAnalysis : public MachineFunctionPass {
public:
  static char ID;
  AArch64CSRegLivenessAnalysis()
...
void AArch64CSRegLivenessAnalysis::getAnalysisUsage(AnalysisUsage &AU) const {
...
bool AArch64CSRegLivenessAnalysis::calculateMachineFunctionCSRegUsage(
...
// function.
void AArch64CSRegLivenessAnalysis::calculateCalleeSavedLiveness(
    MachineFunction &MF) {
  MF.RenumberBlocks();
...
bool AArch64CSRegLivenessAnalysis::analyzeBasicBlock(MachineBasicBlock &MBB) {
...
INITIALIZE_PASS_BEGIN(AArch64CSRegLivenessAnalysis, DEBUG_TYPE,
                      "AArch64 Callee Saved Register Liveness Analysis", false,
                      false)
INITIALIZE_PASS_END(AArch64CSRegLivenessAnalysis, DEBUG_TYPE,
                    "AArch64 Callee Saved Register Liveness Analysis Configure",
                    false, false)

llvm::FunctionPass *llvm::createAArch64CSRegLivenessAnalysisPass() {
  return new AArch64CSRegLivenessAnalysis();
}
